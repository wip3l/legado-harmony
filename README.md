...
| --- | --- |
| 应用包名 | `io.legado.read` |
| 当前版本 | `3.9.906`（以 `AppScope/app.json5` 为准） |
...
- 支持浅色/深色模式、主题包、按钮色、强调色、自定义字体、阅读背景、封面图库和应用图标；应用主题包前会先询问是否一并套用主题排版和主题封面，未勾选的项保留当前设置；导入字体会保留或恢复可读的来源名称。
...
| `versionName` | `3.9.906` |
| `versionCode` / `buildVersion` | `390906` |
| `minAPIVersion` | `12` |
| `targetAPIVersion` | `26` |
