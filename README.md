...
Legado Harmony 是一个面向 HarmonyOS NEXT 的网络小说阅读应用，目标是在鸿蒙端实现类似「阅读 / Legado」的书源导入、搜索、发现、详情解析、目录解析和正文阅读体验。
...
- 悬浮底栏：主页面使用胶囊式悬浮底部操作栏，并接入 HarmonyOS API 23 的系统自适应材质能力。

## 当前状态

这是一个正在迭代中的 HarmonyOS 移植项目，核心目标是让常见 Legado 书源在鸿蒙端可用。
...
本项目仅用于 HarmonyOS NEXT 端阅读应用能力学习、技术验证和开源交流。项目不内置受版权保护的小说内容，也不对第三方书源内容负责。使用第三方书源时请遵守当地法律法规和对应网站协议。

## 致谢

感谢 Legado / 阅读项目及其社区书源生态。本项目的书源规则兼容目标来自该生态，鸿蒙端实现仍在持续补齐中。
